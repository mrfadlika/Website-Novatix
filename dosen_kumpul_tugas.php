            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div align="center">
                        ...
                        <a href="dosen/add/materi" class="btn btn-outline-primary" style="margin-right: 15px">Upload Materi</a>
                        <a href="dosen/kumpul_tugas" class="btn btn-primary">Tugas Mahasiswa</a>
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                                ...
                                <table class="table text-nowrap mb-0 align-middle">
                                    <thead class="text-dark fs-4">
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">Dikumpul Pada</h6>
                                            </th>
                                            <th class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">File Kumpul</h6>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        $sql = "SELECT id, file_upload, tanggal_kumpul, nama_mahasiswa, deskripsi FROM kumpul_tugas WHERE dosen_tujuan='$user_id '";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                $filePath = $row['file_upload'];
                                                $download_file = "<a href='$filePath' download>" . $row['file_upload'] . "</a>";
                ...
                <div class='description'>
                    ...
                    <a href='#' class='toggle-description' data-id='" . $row['id'] . "'>Lihat Selengkapnya</a>
                                            ...
                                            echo "<tr><td colspan='6'>Belum ada yang mengumpulkan</td></tr>";
                                        }
