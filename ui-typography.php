      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <a type="button" href="add-announcement.php?nim=<?php echo $_GET['nim']; ?>" class="btn btn-outline-secondary m-1" style="margin-bottom: 200px">Buat Pengumuman</a>
              <div class="card">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "</div>";
                echo "<span class='ti ti-trash fs-8' onclick='deleteAnnouncement(" . $row["id"] . ")'></span>";
                echo "<hr>";
                echo "</div>";
            }
        } else {
